...
class Telkom extends InvoiceModel{
  String? ppobDetailtagihan;

  Telkom(
      {
        this.ppobDetailtagihan,});

  Telkom.fromJson(Map<String, dynamic> json) {
    result = json['result'];
    ...
    ppobDetailtagihan = json['ppob_detailtagihan'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['ppob_detailtagihan'] = this.ppobDetailtagihan;
