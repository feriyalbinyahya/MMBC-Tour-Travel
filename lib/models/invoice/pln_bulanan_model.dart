...
class PLNBulanan extends InvoiceModel {
  String? ppobStandmeter;
  ...
  PLNBulanan.fromJson(Map<String, dynamic> json) {
    result = json['result'];
    ...
    ppobStandmeter = json['ppob_standmeter'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['ppob_standmeter'] = this.ppobStandmeter;
