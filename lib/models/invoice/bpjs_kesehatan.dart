...
class BPJSKesehatan extends InvoiceModel{
  String? ppobJumlahpeserta;
  String? ppobNamapeserta;

  BPJSKesehatan(
      {
        this.ppobJumlahpeserta,
        this.ppobNamapeserta,});

  BPJSKesehatan.fromJson(Map<String, dynamic> json) {
    result = json['result'];
    ...
    ppobJumlahpeserta = json['ppob_jumlahpeserta'];
    ppobNamapeserta = json['ppob_namapeserta'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['ppob_jumlahpeserta'] = this.ppobJumlahpeserta;
    data['ppob_namapeserta'] = this.ppobNamapeserta;
